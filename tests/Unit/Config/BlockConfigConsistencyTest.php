...
class BlockConfigConsistencyTest extends TestCase
{
    ...
    {
        $template = self::basePath() . '/Resources/views/includes/blocks/' . basename($file, '.xml') . '.html.twig';
    ...
    {
        $slotsFile = self::basePath() . '/Resources/config/blocks/_slots.yaml';
        ...
        foreach ($slots as $slot => $blocks) {
            ...
            foreach ($blocks as $block) {
                ...
                self::assertFileExists(
                    self::basePath() . '/Resources/config/blocks/' . $block . '.xml',
    ...
    {
        $files = glob(self::basePath() . '/Resources/config/blocks/block--*.xml');
